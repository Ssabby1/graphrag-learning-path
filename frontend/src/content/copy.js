export const COPY = {
  en: {
    ...
    citations: "Validated Citations", evidenceRelations: "Path Relationships", integrity: "Citation Integrity", pathCoverage: "Path Evidence Coverage", evidenceId: "Evidence ID", verification: "Verification",
  ...
  zh: {
    ...
    status: "路径状态", source: "回答来源", languageMeta: "回答语言", citations: "有效引用", evidenceRelations: "路径关系", integrity: "引用完整性", pathCoverage: "路径证据覆盖率", evidenceId: "证据 ID", verification: "审核状态",
